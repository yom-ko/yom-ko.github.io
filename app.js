...
// Put arrow wrappers into jQuery variables
const $arrow1Wrapper = $('.arrow_1_wrapper');
const $arrow2Wrapper = $('.arrow_2_wrapper');

// Apply calculated widths to arrow wrappers
$arrow1Wrapper.width(div1Width);
$arrow2Wrapper.width(div2Width);

// Shift arrow 2 start position based on arrow 1 end position and hide it initially
$arrow2Wrapper.css('left', div1Width + 33).hide();
